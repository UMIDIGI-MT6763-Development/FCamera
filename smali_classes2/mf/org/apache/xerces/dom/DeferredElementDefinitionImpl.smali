...
.method constructor <init>(Lmf/org/apache/xerces/dom/DeferredDocumentImpl;I)V
    ...
    invoke-virtual {p0, p1}, Lmf/org/apache/xerces/dom/DeferredElementDefinitionImpl;->needsSyncData(Z)V

    invoke-virtual {p0, p1}, Lmf/org/apache/xerces/dom/DeferredElementDefinitionImpl;->needsSyncChildren(Z)V
...
.method protected synchronizeChildren()V
    ...
    iget-object v1, p0, Lmf/org/apache/xerces/dom/DeferredElementDefinitionImpl;->ownerDocument:Lmf/org/apache/xerces/dom/CoreDocumentImpl;

    const/4 v2, 0x0

    invoke-virtual {v1, v2}, Lmf/org/apache/xerces/dom/CoreDocumentImpl;->setMutationEvents(Z)V

    invoke-virtual {p0, v2}, Lmf/org/apache/xerces/dom/DeferredElementDefinitionImpl;->needsSyncChildren(Z)V

    iget-object v1, p0, Lmf/org/apache/xerces/dom/DeferredElementDefinitionImpl;->ownerDocument:Lmf/org/apache/xerces/dom/CoreDocumentImpl;

    check-cast v1, Lmf/org/apache/xerces/dom/DeferredDocumentImpl;

    new-instance v2, Lmf/org/apache/xerces/dom/NamedNodeMapImpl;

    invoke-direct {v2, v1}, Lmf/org/apache/xerces/dom/NamedNodeMapImpl;-><init>(Lmf/org/apache/xerces/dom/NodeImpl;)V

    iput-object v2, p0, Lmf/org/apache/xerces/dom/DeferredElementDefinitionImpl;->attributes:Lmf/org/apache/xerces/dom/NamedNodeMapImpl;

    iget v2, p0, Lmf/org/apache/xerces/dom/DeferredElementDefinitionImpl;->fNodeIndex:I

    invoke-virtual {v1, v2}, Lmf/org/apache/xerces/dom/DeferredDocumentImpl;->getLastChild(I)I
    ...
    invoke-virtual {v1, v0}, Lmf/org/apache/xerces/dom/DeferredDocumentImpl;->setMutationEvents(Z)V

    return-void

    :cond_0
    invoke-virtual {v1, v2}, Lmf/org/apache/xerces/dom/DeferredDocumentImpl;->getNodeObject(I)Lmf/org/apache/xerces/dom/DeferredNode;
    ...
    invoke-virtual {v1, v2}, Lmf/org/apache/xerces/dom/DeferredDocumentImpl;->getPrevSibling(I)I
