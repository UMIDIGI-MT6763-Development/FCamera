...
.method public constructor <init>(Lmf/org/apache/xerces/dom/CoreDocumentImpl;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lmf/org/apache/xerces/dom/PSVIElementNSImpl;->fDeclaration:Lmf/org/apache/xerces/xs/XSElementDeclaration;

    iput-object p1, p0, Lmf/org/apache/xerces/dom/PSVIElementNSImpl;->fTypeDecl:Lmf/org/apache/xerces/xs/XSTypeDefinition;

    const/4 p2, 0x0

    iput-boolean p2, p0, Lmf/org/apache/xerces/dom/PSVIElementNSImpl;->fNil:Z

    const/4 p3, 0x1

    iput-boolean p3, p0, Lmf/org/apache/xerces/dom/PSVIElementNSImpl;->fSpecified:Z
    ...
    iput-object p3, p0, Lmf/org/apache/xerces/dom/PSVIElementNSImpl;->fValue:Lmf/org/apache/xerces/impl/dv/ValidatedInfo;

    iput-object p1, p0, Lmf/org/apache/xerces/dom/PSVIElementNSImpl;->fNotation:Lmf/org/apache/xerces/xs/XSNotationDeclaration;

    iput-short p2, p0, Lmf/org/apache/xerces/dom/PSVIElementNSImpl;->fValidationAttempted:S

    iput-short p2, p0, Lmf/org/apache/xerces/dom/PSVIElementNSImpl;->fValidity:S

    iput-object p1, p0, Lmf/org/apache/xerces/dom/PSVIElementNSImpl;->fErrorCodes:Lmf/org/apache/xerces/xs/StringList;

    iput-object p1, p0, Lmf/org/apache/xerces/dom/PSVIElementNSImpl;->fErrorMessages:Lmf/org/apache/xerces/xs/StringList;

    iput-object p1, p0, Lmf/org/apache/xerces/dom/PSVIElementNSImpl;->fValidationContext:Ljava/lang/String;

    iput-object p1, p0, Lmf/org/apache/xerces/dom/PSVIElementNSImpl;->fSchemaInformation:Lmf/org/apache/xerces/xs/XSModel;
...
.method public setPSVI(Lmf/org/apache/xerces/xs/ElementPSVI;)V
    ...
    instance-of v1, v0, Lmf/org/apache/xerces/xs/XSSimpleTypeDefinition;

    if-nez v1, :cond_1

    instance-of v1, v0, Lmf/org/apache/xerces/xs/XSComplexTypeDefinition;
    ...
    iput-boolean p1, p0, Lmf/org/apache/xerces/dom/PSVIElementNSImpl;->fNil:Z
