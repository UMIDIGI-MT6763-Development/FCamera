...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmf/javax/xml/validation/SchemaFactoryFinder;->ss:Lmf/javax/xml/validation/SecuritySupport;

    new-instance v0, Ljava/util/Properties;

    invoke-direct {v0}, Ljava/util/Properties;-><init>()V

    sput-object v0, Lmf/javax/xml/validation/SchemaFactoryFinder;->cacheProps:Ljava/util/Properties;
...
.method public constructor <init>(Ljava/lang/ClassLoader;)V
    ...
    sget-boolean p1, Lmf/javax/xml/validation/SchemaFactoryFinder;->debug:Z
...
.method private _newFactory(Ljava/lang/String;)Lmf/javax/xml/validation/SchemaFactory;
    ...
    invoke-virtual {v2, v0}, Lmf/javax/xml/validation/SecuritySupport;->getSystemProperty(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3}, Lmf/javax/xml/validation/SchemaFactoryFinder;->debugPrintln(Ljava/lang/String;)V

    invoke-virtual {p0, v2, v1}, Lmf/javax/xml/validation/SchemaFactoryFinder;->createInstance(Ljava/lang/String;Z)Lmf/javax/xml/validation/SchemaFactory;
    ...
    sget-object v3, Lmf/javax/xml/validation/SchemaFactoryFinder;->cacheProps:Ljava/util/Properties;
    ...
    :try_start_2
    sget-boolean v4, Lmf/javax/xml/validation/SchemaFactoryFinder;->firstTime:Z
    ...
    sput-boolean v2, Lmf/javax/xml/validation/SchemaFactoryFinder;->firstTime:Z

    sget-object v2, Lmf/javax/xml/validation/SchemaFactoryFinder;->ss:Lmf/javax/xml/validation/SecuritySupport;

    invoke-virtual {v2, v4}, Lmf/javax/xml/validation/SecuritySupport;->doesFileExist(Ljava/io/File;)Z
    ...
    sget-object v5, Lmf/javax/xml/validation/SchemaFactoryFinder;->ss:Lmf/javax/xml/validation/SecuritySupport;

    invoke-virtual {v5, v4}, Lmf/javax/xml/validation/SecuritySupport;->getFileInputStream(Ljava/io/File;)Ljava/io/FileInputStream;
    ...
    const-string p1, "attempting to use the platform default XML Schema validator"

    invoke-static {p1}, Lmf/javax/xml/validation/SchemaFactoryFinder;->debugPrintln(Ljava/lang/String;)V

    const-string p1, "com.sun.org.apache.xerces.internal.jaxp.validation.XMLSchemaFactory"

    invoke-virtual {p0, p1, v1}, Lmf/javax/xml/validation/SchemaFactoryFinder;->createInstance(Ljava/lang/String;Z)Lmf/javax/xml/validation/SchemaFactory;
    ...
    invoke-virtual {v4, v2}, Lmf/javax/xml/validation/SecuritySupport;->getURLInputStream(Ljava/net/URL;)Ljava/io/InputStream;

    move-result-object v4

    invoke-direct {p0, p1, v3, v4}, Lmf/javax/xml/validation/SchemaFactoryFinder;->loadFromService(Ljava/lang/String;Ljava/lang/String;Ljava/io/InputStream;)Lmf/javax/xml/validation/SchemaFactory;
    ...
    sget-boolean v4, Lmf/javax/xml/validation/SchemaFactoryFinder;->debug:Z
...
.method private createServiceFileIterator()Ljava/util/Iterator;
    ...
    invoke-virtual {v1, v0, v2}, Lmf/javax/xml/validation/SecuritySupport;->getResources(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/util/Enumeration;
...
.method private loadFromProperty(Ljava/lang/String;Ljava/lang/String;Ljava/io/InputStream;)Lmf/javax/xml/validation/SchemaFactory;
    ...
    invoke-static {p2}, Lmf/javax/xml/validation/SchemaFactoryFinder;->debugPrintln(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p2}, Lmf/javax/xml/validation/SchemaFactoryFinder;->createInstance(Ljava/lang/String;)Lmf/javax/xml/validation/SchemaFactory;
...
.method private loadFromService(Ljava/lang/String;Ljava/lang/String;Ljava/io/InputStream;)Lmf/javax/xml/validation/SchemaFactory;
    ...
    :cond_2
    invoke-direct {p0, p2}, Lmf/javax/xml/validation/SchemaFactoryFinder;->createClass(Ljava/lang/String;)Ljava/lang/Class;
    ...
    check-cast p3, Lmf/javax/xml/validation/SchemaFactory;
    :try_end_0
    ...
    :try_start_1
    const-string v2, "isSchemaLanguageSupported"
...
.method private static newInstanceNoServiceLoader(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    :cond_0
    :try_start_0
    const-string v0, "newXMLSchemaFactoryNoServiceLoader"
...
.method private static which(Ljava/lang/Class;)Ljava/lang/String;
    ...
    invoke-static {v0, p0}, Lmf/javax/xml/validation/SchemaFactoryFinder;->which(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/String;
...
.method private static which(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p1, p0}, Lmf/javax/xml/validation/SecuritySupport;->getResourceAsURL(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/net/URL;
...
.method createInstance(Ljava/lang/String;Z)Lmf/javax/xml/validation/SchemaFactory;
    ...
    invoke-static {v0}, Lmf/javax/xml/validation/SchemaFactoryFinder;->which(Ljava/lang/Class;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {v0}, Lmf/javax/xml/validation/SchemaFactoryFinder;->newInstanceNoServiceLoader(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lmf/javax/xml/validation/SchemaFactory;
    ...
    sget-boolean p2, Lmf/javax/xml/validation/SchemaFactoryFinder;->debug:Z
