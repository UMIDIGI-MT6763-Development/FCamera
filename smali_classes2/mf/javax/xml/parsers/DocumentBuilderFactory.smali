...
.method protected constructor <init>()V
    ...
    iput-boolean v0, p0, Lmf/javax/xml/parsers/DocumentBuilderFactory;->validating:Z

    iput-boolean v0, p0, Lmf/javax/xml/parsers/DocumentBuilderFactory;->namespaceAware:Z

    iput-boolean v0, p0, Lmf/javax/xml/parsers/DocumentBuilderFactory;->whitespace:Z

    const/4 v1, 0x1

    iput-boolean v1, p0, Lmf/javax/xml/parsers/DocumentBuilderFactory;->expandEntityRef:Z

    iput-boolean v0, p0, Lmf/javax/xml/parsers/DocumentBuilderFactory;->ignoreComments:Z

    iput-boolean v0, p0, Lmf/javax/xml/parsers/DocumentBuilderFactory;->coalescing:Z

    iput-boolean v0, p0, Lmf/javax/xml/parsers/DocumentBuilderFactory;->canonicalState:Z
...
.method public static newInstance()Lmf/javax/xml/parsers/DocumentBuilderFactory;
    ...
    const-string v1, "com.sun.org.apache.xerces.internal.jaxp.DocumentBuilderFactoryImpl"
...
.method public static newInstance(Ljava/lang/String;Ljava/lang/ClassLoader;)Lmf/javax/xml/parsers/DocumentBuilderFactory;
    ...
    check-cast p0, Lmf/javax/xml/parsers/DocumentBuilderFactory;
    :try_end_0
    .catch Lmf/javax/xml/parsers/FactoryFinder$ConfigurationError; {:try_start_0 .. :try_end_0} :catch_0
    ...
    new-instance p1, Lmf/javax/xml/parsers/FactoryConfigurationError;

    invoke-virtual {p0}, Lmf/javax/xml/parsers/FactoryFinder$ConfigurationError;->getException()Ljava/lang/Exception;

    move-result-object v0

    invoke-virtual {p0}, Lmf/javax/xml/parsers/FactoryFinder$ConfigurationError;->getMessage()Ljava/lang/String;

    move-result-object p0

    invoke-direct {p1, v0, p0}, Lmf/javax/xml/parsers/FactoryConfigurationError;-><init>(Ljava/lang/Exception;Ljava/lang/String;)V
...
.method public setXIncludeAware(Z)V
    ...
    const-string v1, " setXIncludeAware is not supported on this JAXP implementation or earlier: "
