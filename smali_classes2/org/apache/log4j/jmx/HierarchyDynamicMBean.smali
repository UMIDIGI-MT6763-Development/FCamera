...
.method addLoggerMBean(Lorg/apache/log4j/Logger;)Ljavax/management/ObjectName;
    ...
    invoke-interface {v4, v3}, Ljavax/management/MBeanServer;->isRegistered(Ljavax/management/ObjectName;)Z

    move-result v4

    if-nez v4, :cond_0

    invoke-virtual {p0, v2, v3}, Lorg/apache/log4j/jmx/HierarchyDynamicMBean;->registerMBean(Ljava/lang/Object;Ljavax/management/ObjectName;)V
    ...
    invoke-virtual {p1, v5}, Lorg/apache/log4j/Logger;->debug(Ljava/lang/Object;)V
