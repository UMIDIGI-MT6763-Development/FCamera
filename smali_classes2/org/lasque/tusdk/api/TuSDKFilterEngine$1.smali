.class Lorg/lasque/tusdk/api/TuSDKFilterEngine$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lorg/lasque/tusdk/api/TuSDKFilterEngine;->e()V
.end annotation
...
.method constructor <init>(Lorg/lasque/tusdk/api/TuSDKFilterEngine;)V
    ...
    iput-object p1, p0, Lorg/lasque/tusdk/api/TuSDKFilterEngine$1;->a:Lorg/lasque/tusdk/api/TuSDKFilterEngine;
...
.method public run()V
    ...
    iget-object v0, p0, Lorg/lasque/tusdk/api/TuSDKFilterEngine$1;->a:Lorg/lasque/tusdk/api/TuSDKFilterEngine;

    invoke-static {v0}, Lorg/lasque/tusdk/api/TuSDKFilterEngine;->a(Lorg/lasque/tusdk/api/TuSDKFilterEngine;)Z
    ...
    const-string v2, "varying highp vec2 textureCoordinate;uniform sampler2D inputImageTexture;void main(){     gl_FragColor = texture2D(inputImageTexture, textureCoordinate);}"
    ...
    invoke-static {v0, v1}, Lorg/lasque/tusdk/api/TuSDKFilterEngine;->a(Lorg/lasque/tusdk/api/TuSDKFilterEngine;Lorg/lasque/tusdk/core/seles/SelesGLProgram;)Lorg/lasque/tusdk/core/seles/SelesGLProgram;

    iget-object v0, p0, Lorg/lasque/tusdk/api/TuSDKFilterEngine$1;->a:Lorg/lasque/tusdk/api/TuSDKFilterEngine;

    invoke-static {v0}, Lorg/lasque/tusdk/api/TuSDKFilterEngine;->b(Lorg/lasque/tusdk/api/TuSDKFilterEngine;)Lorg/lasque/tusdk/core/seles/SelesGLProgram;
    ...
    iget-object v3, p0, Lorg/lasque/tusdk/api/TuSDKFilterEngine$1;->a:Lorg/lasque/tusdk/api/TuSDKFilterEngine;

    invoke-static {v3}, Lorg/lasque/tusdk/api/TuSDKFilterEngine;->b(Lorg/lasque/tusdk/api/TuSDKFilterEngine;)Lorg/lasque/tusdk/core/seles/SelesGLProgram;
    ...
    invoke-static {v0, v2}, Lorg/lasque/tusdk/api/TuSDKFilterEngine;->a(Lorg/lasque/tusdk/api/TuSDKFilterEngine;Lorg/lasque/tusdk/core/seles/SelesGLProgram;)Lorg/lasque/tusdk/core/seles/SelesGLProgram;
    ...
    invoke-static {v0, v1}, Lorg/lasque/tusdk/api/TuSDKFilterEngine;->a(Lorg/lasque/tusdk/api/TuSDKFilterEngine;I)I
    ...
    invoke-static {v0, v1}, Lorg/lasque/tusdk/api/TuSDKFilterEngine;->b(Lorg/lasque/tusdk/api/TuSDKFilterEngine;I)I
    ...
    invoke-static {v0, v1}, Lorg/lasque/tusdk/api/TuSDKFilterEngine;->c(Lorg/lasque/tusdk/api/TuSDKFilterEngine;I)I
    ...
    invoke-static {v0}, Lorg/lasque/tusdk/api/TuSDKFilterEngine;->c(Lorg/lasque/tusdk/api/TuSDKFilterEngine;)I
    ...
    invoke-static {v0}, Lorg/lasque/tusdk/api/TuSDKFilterEngine;->d(Lorg/lasque/tusdk/api/TuSDKFilterEngine;)I
