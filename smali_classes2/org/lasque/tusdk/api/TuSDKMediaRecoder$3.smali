.class Lorg/lasque/tusdk/api/TuSDKMediaRecoder$3;
...
.method constructor <init>(Lorg/lasque/tusdk/api/TuSDKMediaRecoder;)V
    ...
    iput-object p1, p0, Lorg/lasque/tusdk/api/TuSDKMediaRecoder$3;->a:Lorg/lasque/tusdk/api/TuSDKMediaRecoder;
...
.method private a(Landroid/media/MediaCodec$BufferInfo;)Z
    ...
    iget-object v0, p0, Lorg/lasque/tusdk/api/TuSDKMediaRecoder$3;->a:Lorg/lasque/tusdk/api/TuSDKMediaRecoder;

    invoke-static {v0}, Lorg/lasque/tusdk/api/TuSDKMediaRecoder;->e(Lorg/lasque/tusdk/api/TuSDKMediaRecoder;)J
    ...
    invoke-static {v0, v1, v2}, Lorg/lasque/tusdk/api/TuSDKMediaRecoder;->c(Lorg/lasque/tusdk/api/TuSDKMediaRecoder;J)J

    :cond_0
    iget-wide v0, p1, Landroid/media/MediaCodec$BufferInfo;->presentationTimeUs:J

    iget-object v2, p0, Lorg/lasque/tusdk/api/TuSDKMediaRecoder$3;->a:Lorg/lasque/tusdk/api/TuSDKMediaRecoder;

    invoke-static {v2}, Lorg/lasque/tusdk/api/TuSDKMediaRecoder;->g(Lorg/lasque/tusdk/api/TuSDKMediaRecoder;)J
    ...
    invoke-static {v0, v1, v2}, Lorg/lasque/tusdk/api/TuSDKMediaRecoder;->b(Lorg/lasque/tusdk/api/TuSDKMediaRecoder;J)J
...
.method public onVideoEncoderFrameDataAvailable(JLjava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
    ...
    iget-object p1, p0, Lorg/lasque/tusdk/api/TuSDKMediaRecoder$3;->a:Lorg/lasque/tusdk/api/TuSDKMediaRecoder;
    ...
    :cond_0
    invoke-direct {p0, p4}, Lorg/lasque/tusdk/api/TuSDKMediaRecoder$3;->a(Landroid/media/MediaCodec$BufferInfo;)Z
...
.method public onVideoEncoderStarted(Landroid/media/MediaFormat;)V
    ...
    invoke-static {p1}, Lorg/lasque/tusdk/api/TuSDKMediaRecoder;->c(Lorg/lasque/tusdk/api/TuSDKMediaRecoder;)Lorg/lasque/tusdk/core/audio/TuSDKAudioRecorderCore;
    ...
    invoke-static {p1}, Lorg/lasque/tusdk/api/TuSDKMediaRecoder;->d(Lorg/lasque/tusdk/api/TuSDKMediaRecoder;)Z
