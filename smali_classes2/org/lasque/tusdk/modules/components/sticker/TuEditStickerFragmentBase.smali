.class public abstract Lorg/lasque/tusdk/modules/components/sticker/TuEditStickerFragmentBase;
...
# virtual methods
.method public final appendStickerItem(Landroid/graphics/Bitmap;)V
    .locals 1

    if-eqz p1, :cond_1

    invoke-virtual {p0}, Lorg/lasque/tusdk/modules/components/sticker/TuEditStickerFragmentBase;->getStickerView()Lorg/lasque/tusdk/impl/components/widget/sticker/StickerView;
    ...
    invoke-virtual {v0, p1}, Lorg/lasque/tusdk/impl/components/widget/sticker/StickerView;->appendSticker(Landroid/graphics/Bitmap;)V
...
.method protected asyncEditWithResult(Lorg/lasque/tusdk/core/TuSdkResult;)V
    ...
    invoke-virtual {p0, p1}, Lorg/lasque/tusdk/modules/components/sticker/TuEditStickerFragmentBase;->loadOrginImage(Lorg/lasque/tusdk/core/TuSdkResult;)V
    ...
    invoke-virtual {p0}, Lorg/lasque/tusdk/modules/components/sticker/TuEditStickerFragmentBase;->isShowResultPreview()Z
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lorg/lasque/tusdk/modules/components/sticker/TuEditStickerFragmentBase;->asyncProcessingIfNeedSave(Lorg/lasque/tusdk/core/TuSdkResult;)V
...
.method protected handleBackButton()V
    ...
    invoke-virtual {p0, v0}, Lorg/lasque/tusdk/modules/components/sticker/TuEditStickerFragmentBase;->navigatorBarBackAction(Lorg/lasque/tusdk/core/view/widget/TuSdkNavigatorBar$NavigatorBarButtonInterface;)V
...
.method protected handleCompleteButton()V
    ...
    invoke-virtual {p0}, Lorg/lasque/tusdk/modules/components/sticker/TuEditStickerFragmentBase;->handleBackButton()V
    ...
    invoke-virtual {p0}, Lorg/lasque/tusdk/modules/components/sticker/TuEditStickerFragmentBase;->getCutRegionView()Lorg/lasque/tusdk/core/view/widget/TuMaskRegionView;
    ...
    invoke-virtual {p0, v1}, Lorg/lasque/tusdk/modules/components/sticker/TuEditStickerFragmentBase;->hubStatus(Ljava/lang/String;)V

    new-instance v1, Ljava/lang/Thread;

    new-instance v2, Lorg/lasque/tusdk/modules/components/sticker/TuEditStickerFragmentBase$1;

    invoke-direct {v2, p0, v0}, Lorg/lasque/tusdk/modules/components/sticker/TuEditStickerFragmentBase$1;-><init>(Lorg/lasque/tusdk/modules/components/sticker/TuEditStickerFragmentBase;Lorg/lasque/tusdk/core/TuSdkResult;)V
...
.method protected loadView(Landroid/view/ViewGroup;)V
    ...
    sget-wide v0, Lorg/lasque/tusdk/modules/components/ComponentActType;->editStickerFragment:J
