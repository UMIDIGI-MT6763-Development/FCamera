.class public abstract Lorg/lasque/tusdk/modules/components/filter/TuMutibleEditAdjustFragmentBase;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lorg/lasque/tusdk/modules/components/filter/TuMutibleEditAdjustFragmentBase;->a:I
...
.method private a()Lorg/lasque/tusdk/core/seles/tusdk/FilterWrap;
    ...
    new-instance v0, Lorg/lasque/tusdk/modules/components/filter/TuMutibleEditAdjustFragmentBase$1;

    invoke-direct {v0, p0}, Lorg/lasque/tusdk/modules/components/filter/TuMutibleEditAdjustFragmentBase$1;-><init>(Lorg/lasque/tusdk/modules/components/filter/TuMutibleEditAdjustFragmentBase;)V
...
.method protected buildActionButtons()V
    ...
    invoke-virtual {p0}, Lorg/lasque/tusdk/modules/components/filter/TuMutibleEditAdjustFragmentBase;->getFilterParameter()Lorg/lasque/tusdk/core/seles/SelesParameters;
    ...
    invoke-virtual {p0, v2, v1}, Lorg/lasque/tusdk/modules/components/filter/TuMutibleEditAdjustFragmentBase;->buildActionButton(Ljava/lang/String;I)Landroid/view/View;
...
.method public getCurrentAction()I
    ...
    iget v0, p0, Lorg/lasque/tusdk/modules/components/filter/TuMutibleEditAdjustFragmentBase;->a:I
...
.method protected handleAction(Ljava/lang/Integer;)V
    ...
    iput p1, p0, Lorg/lasque/tusdk/modules/components/filter/TuMutibleEditAdjustFragmentBase;->a:I

    invoke-virtual {p0}, Lorg/lasque/tusdk/modules/components/filter/TuMutibleEditAdjustFragmentBase;->getConfigView()Landroid/view/View;
    ...
    iget v1, p0, Lorg/lasque/tusdk/modules/components/filter/TuMutibleEditAdjustFragmentBase;->a:I
    ...
    invoke-virtual {p0, p1}, Lorg/lasque/tusdk/modules/components/filter/TuMutibleEditAdjustFragmentBase;->setConfigViewShowState(Z)V
...
.method protected handleConfigCompeleteButton()V
    ...
    invoke-virtual {p0, v0}, Lorg/lasque/tusdk/modules/components/filter/TuMutibleEditAdjustFragmentBase;->setConfigViewShowState(Z)V
...
.method protected loadView(Landroid/view/ViewGroup;)V
    ...
    invoke-direct {p0}, Lorg/lasque/tusdk/modules/components/filter/TuMutibleEditAdjustFragmentBase;->a()Lorg/lasque/tusdk/core/seles/tusdk/FilterWrap;

    move-result-object v0

    invoke-virtual {p0, v0}, Lorg/lasque/tusdk/modules/components/filter/TuMutibleEditAdjustFragmentBase;->setFilterWrap(Lorg/lasque/tusdk/core/seles/tusdk/FilterWrap;)V

    invoke-super {p0, p1}, Lorg/lasque/tusdk/impl/activity/TuFilterResultFragment;->loadView(Landroid/view/ViewGroup;)V

    invoke-virtual {p0}, Lorg/lasque/tusdk/modules/components/filter/TuMutibleEditAdjustFragmentBase;->buildActionButtons()V
...
.method public onParameterConfigDataChanged(Lorg/lasque/tusdk/impl/view/widget/ParameterConfigViewInterface;IF)V
    ...
    iget p2, p0, Lorg/lasque/tusdk/modules/components/filter/TuMutibleEditAdjustFragmentBase;->a:I
