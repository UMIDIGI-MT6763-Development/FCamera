...
.method private computeCofactor(II)F
    ...
    iget-object v7, v6, Landroid/support/v8/renderscript/Matrix4f;->mMat:[F
...
.method public load(Landroid/support/v8/renderscript/Matrix3f;)V
    ...
    iget-object v3, p1, Landroid/support/v8/renderscript/Matrix3f;->mMat:[F
    ...
    iget-object v4, p1, Landroid/support/v8/renderscript/Matrix3f;->mMat:[F
    ...
    iget-object p1, p0, Landroid/support/v8/renderscript/Matrix4f;->mMat:[F
...
.method public loadMultiply(Landroid/support/v8/renderscript/Matrix4f;Landroid/support/v8/renderscript/Matrix4f;)V
    ...
    invoke-virtual {p2, v1, v3}, Landroid/support/v8/renderscript/Matrix4f;->get(II)F

    move-result v11

    invoke-virtual {p1, v3, v0}, Landroid/support/v8/renderscript/Matrix4f;->get(II)F
    ...
    invoke-virtual {p1, v3, v10}, Landroid/support/v8/renderscript/Matrix4f;->get(II)F
    ...
    invoke-virtual {p1, v3, v9}, Landroid/support/v8/renderscript/Matrix4f;->get(II)F
    ...
    invoke-virtual {p1, v3, v8}, Landroid/support/v8/renderscript/Matrix4f;->get(II)F
    ...
    :cond_0
    invoke-virtual {p0, v1, v0, v4}, Landroid/support/v8/renderscript/Matrix4f;->set(IIF)V

    invoke-virtual {p0, v1, v10, v5}, Landroid/support/v8/renderscript/Matrix4f;->set(IIF)V

    invoke-virtual {p0, v1, v9, v6}, Landroid/support/v8/renderscript/Matrix4f;->set(IIF)V

    invoke-virtual {p0, v1, v8, v7}, Landroid/support/v8/renderscript/Matrix4f;->set(IIF)V
...
.method public loadProjectionNormalized(II)V
    ...
    invoke-virtual {v8, p1, v0, p2, v0}, Landroid/support/v8/renderscript/Matrix4f;->loadRotate(FFFF)V
    ...
    invoke-virtual {v8, p1, v1, p2}, Landroid/support/v8/renderscript/Matrix4f;->loadScale(FFF)V

    invoke-virtual {v7, v7, v8}, Landroid/support/v8/renderscript/Matrix4f;->loadMultiply(Landroid/support/v8/renderscript/Matrix4f;Landroid/support/v8/renderscript/Matrix4f;)V

    invoke-virtual {v8, v0, v0, v1}, Landroid/support/v8/renderscript/Matrix4f;->loadTranslate(FFF)V
