.class public Lcom/baidu/platform/comapi/util/b;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/baidu/platform/comapi/util/b$a;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/baidu/platform/comapi/util/b;->a:Landroid/os/Bundle;
    ...
    sput-object v1, Lcom/baidu/platform/comapi/util/b;->b:[D

    new-array v1, v0, [D

    fill-array-data v1, :array_1

    sput-object v1, Lcom/baidu/platform/comapi/util/b;->c:[D
    ...
    sput-object v1, Lcom/baidu/platform/comapi/util/b;->d:[[D
    ...
    sput-object v0, Lcom/baidu/platform/comapi/util/b;->e:[[D
...
.method public static a(Lcom/baidu/mapapi/model/LatLng;I)I
    ...
    invoke-static {p1}, Lcom/baidu/platform/comapi/util/b;->a(Lcom/baidu/mapapi/model/LatLng;)Lcom/baidu/mapapi/model/inner/GeoPoint;
...
.method public static a(Lcom/baidu/mapapi/model/inner/GeoPoint;)Lcom/baidu/mapapi/model/LatLng;
    ...
    new-instance v0, Lcom/baidu/platform/comapi/util/b$a;

    invoke-direct {v0}, Lcom/baidu/platform/comapi/util/b$a;-><init>()V

    invoke-virtual {p0}, Lcom/baidu/mapapi/model/inner/GeoPoint;->getLongitudeE6()D

    move-result-wide v1

    iput-wide v1, v0, Lcom/baidu/platform/comapi/util/b$a;->a:D

    invoke-virtual {p0}, Lcom/baidu/mapapi/model/inner/GeoPoint;->getLatitudeE6()D

    move-result-wide v1

    iput-wide v1, v0, Lcom/baidu/platform/comapi/util/b$a;->b:D

    new-instance p0, Lcom/baidu/platform/comapi/util/b$a;

    invoke-direct {p0}, Lcom/baidu/platform/comapi/util/b$a;-><init>()V

    iget-wide v1, v0, Lcom/baidu/platform/comapi/util/b$a;->a:D

    iput-wide v1, p0, Lcom/baidu/platform/comapi/util/b$a;->a:D

    iget-wide v1, p0, Lcom/baidu/platform/comapi/util/b$a;->a:D

    const-wide v3, 0x41731bf84578d4feL    # 2.0037508342E7

    cmpl-double v1, v1, v3

    const-wide v5, -0x3e8ce407ba872b02L    # -2.0037508342E7

    if-lez v1, :cond_0

    iput-wide v3, p0, Lcom/baidu/platform/comapi/util/b$a;->a:D
    ...
    iput-wide v5, p0, Lcom/baidu/platform/comapi/util/b$a;->a:D

    :cond_1
    :goto_0
    iget-wide v0, v0, Lcom/baidu/platform/comapi/util/b$a;->b:D

    iput-wide v0, p0, Lcom/baidu/platform/comapi/util/b$a;->b:D

    iget-wide v0, p0, Lcom/baidu/platform/comapi/util/b$a;->b:D
    ...
    iget-wide v9, p0, Lcom/baidu/platform/comapi/util/b$a;->b:D
    ...
    :goto_1
    iput-wide v7, p0, Lcom/baidu/platform/comapi/util/b$a;->b:D

    goto :goto_2

    :cond_2
    iget-wide v7, p0, Lcom/baidu/platform/comapi/util/b$a;->b:D
    ...
    iput-wide v3, p0, Lcom/baidu/platform/comapi/util/b$a;->b:D
    ...
    iput-wide v5, p0, Lcom/baidu/platform/comapi/util/b$a;->b:D
    ...
    iget-wide v2, p0, Lcom/baidu/platform/comapi/util/b$a;->b:D

    invoke-static {v2, v3}, Ljava/lang/Math;->abs(D)D

    move-result-wide v2

    sget-object v4, Lcom/baidu/platform/comapi/util/b;->b:[D
    ...
    sget-object v0, Lcom/baidu/platform/comapi/util/b;->d:[[D
    ...
    :cond_7
    :goto_4
    invoke-static {p0, v0}, Lcom/baidu/platform/comapi/util/b;->a(Lcom/baidu/platform/comapi/util/b$a;[D)Lcom/baidu/platform/comapi/util/b$a;

    move-result-object p0

    new-instance v0, Lcom/baidu/mapapi/model/LatLng;

    iget-wide v1, p0, Lcom/baidu/platform/comapi/util/b$a;->b:D

    iget-wide v3, p0, Lcom/baidu/platform/comapi/util/b$a;->a:D
...
.method public static a(Ljava/lang/String;)Lcom/baidu/mapapi/model/LatLng;
    ...
    :cond_0
    sget-object v0, Lcom/baidu/platform/comapi/util/b;->a:Landroid/os/Bundle;
    ...
    sget-object p0, Lcom/baidu/platform/comapi/util/b;->a:Landroid/os/Bundle;

    invoke-static {p0}, Lcom/baidu/platform/comjni/tools/JNITools;->TransGeoStr2Pt(Ljava/lang/Object;)Z

    new-instance p0, Lcom/baidu/mapapi/model/inner/GeoPoint;

    const-wide/16 v0, 0x0

    invoke-direct {p0, v0, v1, v0, v1}, Lcom/baidu/mapapi/model/inner/GeoPoint;-><init>(DD)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/baidu/mapapi/model/inner/GeoPoint;->setLongitudeE6(D)V
...
.method public static a(Lcom/baidu/mapapi/model/LatLng;)Lcom/baidu/mapapi/model/inner/GeoPoint;
    ...
    iget-wide v1, v0, Lcom/baidu/platform/comapi/util/b$a;->b:D
    ...
    iput-wide v3, v0, Lcom/baidu/platform/comapi/util/b$a;->b:D

    :cond_0
    const/4 v1, 0x0

    :goto_0
    sget-object v2, Lcom/baidu/platform/comapi/util/b;->c:[D

    array-length v2, v2

    if-ge v1, v2, :cond_2

    iget-wide v2, v0, Lcom/baidu/platform/comapi/util/b$a;->b:D

    sget-object v4, Lcom/baidu/platform/comapi/util/b;->c:[D
    ...
    sget-object v2, Lcom/baidu/platform/comapi/util/b;->e:[[D
    ...
    iput-wide v2, v0, Lcom/baidu/platform/comapi/util/b$a;->a:D

    iget-wide v2, p0, Lcom/baidu/mapapi/model/LatLng;->latitude:D

    iput-wide v2, v0, Lcom/baidu/platform/comapi/util/b$a;->b:D

    invoke-static {v0, v1}, Lcom/baidu/platform/comapi/util/b;->a(Lcom/baidu/platform/comapi/util/b$a;[D)Lcom/baidu/platform/comapi/util/b$a;
...
.method public static a(FFLjava/lang/String;)Lcom/baidu/mapapi/model/inner/Point;
    .locals 2
    ...
    new-instance p2, Lcom/baidu/mapapi/model/inner/Point;

    float-to-int p0, p0

    float-to-int p1, p1

    invoke-direct {p2, p0, p1}, Lcom/baidu/mapapi/model/inner/Point;-><init>(II)V
    ...
    invoke-static {p0, p1, p2, v1}, Lcom/baidu/platform/comjni/tools/JNITools;->CoordinateEncryptEx(FFLjava/lang/String;Ljava/lang/Object;)Z
    ...
    invoke-direct {p0, p1, p1}, Lcom/baidu/mapapi/model/inner/Point;-><init>(II)V
    ...
    invoke-virtual {p0, p1}, Lcom/baidu/mapapi/model/inner/Point;->setmPtx(I)V
    ...
    invoke-virtual {p0, p1}, Lcom/baidu/mapapi/model/inner/Point;->setmPty(I)V
...
.method static a(Lcom/baidu/platform/comapi/util/b$a;[D)Lcom/baidu/platform/comapi/util/b$a;
    .locals 10
    ...
    iget-wide v6, p0, Lcom/baidu/platform/comapi/util/b$a;->a:D
    ...
    iput-wide v4, v0, Lcom/baidu/platform/comapi/util/b$a;->b:D

    iget-wide v1, v0, Lcom/baidu/platform/comapi/util/b$a;->a:D

    iget-wide v4, p0, Lcom/baidu/platform/comapi/util/b$a;->a:D
    ...
    iget-wide p0, p0, Lcom/baidu/platform/comapi/util/b$a;->b:D
...
.method public static b(Ljava/lang/String;)Lcom/baidu/mapapi/model/LatLng;
    ...
    invoke-static {p0}, Lcom/baidu/platform/comjni/tools/JNITools;->TransNodeStr2Pt(Ljava/lang/Object;)V
    ...
    sget-object v2, Lcom/baidu/platform/comapi/util/b;->a:Landroid/os/Bundle;
    ...
    invoke-direct {p0, v0, v1, v2, v3}, Lcom/baidu/mapapi/model/inner/GeoPoint;-><init>(DD)V
...
.method public static b(Lcom/baidu/mapapi/model/LatLng;)Lcom/baidu/mapapi/model/inner/Point;
    ...
    invoke-static {v0, p0, v1}, Lcom/baidu/platform/comapi/util/b;->a(FFLjava/lang/String;)Lcom/baidu/mapapi/model/inner/Point;
...
.method public static c(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p0}, Lcom/baidu/platform/comjni/tools/a;->a(Ljava/lang/String;)Lcom/baidu/mapapi/model/inner/a;
    ...
    invoke-static {v3}, Lcom/baidu/platform/comapi/util/b;->a(Lcom/baidu/mapapi/model/inner/GeoPoint;)Lcom/baidu/mapapi/model/LatLng;
...
.method public static d(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {v4}, Lcom/baidu/platform/comapi/util/b;->a(Lcom/baidu/mapapi/model/inner/GeoPoint;)Lcom/baidu/mapapi/model/LatLng;
