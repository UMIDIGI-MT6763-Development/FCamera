...
.method public static popScissors()Lcom/badlogic/gdx/math/Rectangle;
    ...
    invoke-interface {v2, v3, v4, v5, v1}, Lcom/badlogic/gdx/graphics/GL20;->glScissor(IIII)V
...
.method public static pushScissors(Lcom/badlogic/gdx/math/Rectangle;)Z
    ...
    invoke-interface {v0, v2, v3, v4, p0}, Lcom/badlogic/gdx/graphics/GL20;->glScissor(IIII)V
