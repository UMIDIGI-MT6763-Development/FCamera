...
.method private buildVertexAttributes(ZZI)[Lcom/badlogic/gdx/graphics/VertexAttribute;
    ...
    invoke-direct {v1, v4, v3, v2}, Lcom/badlogic/gdx/graphics/VertexAttribute;-><init>(IILjava/lang/String;)V
...
.method private static createFragmentShader(ZZI)Ljava/lang/String;
    ...
    const-string v1, "uniform sampler2D u_sampler"
    ...
    const-string p0, " texture2D(u_sampler"
...
.method private static createVertexShader(ZZI)Ljava/lang/String;
    ...
    const-string v1, "attribute vec2 a_texCoord"
    ...
    const-string v1, "uniform mat4 u_projModelView;\n"
