.class public Lcom/freeme/elementscenter/ui/ECChildMode;
.super Lcom/freeme/elementscenter/ui/ECBackHandledFragment;
.source "ECChildMode.java"
...
.field private mAdapter:Lcom/freeme/elementscenter/ui/ECChildModeItemAdapter;
...
.method private constructManagerDatas()Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/freeme/elementscenter/ui/ECChildMode;->mAdapter:Lcom/freeme/elementscenter/ui/ECChildModeItemAdapter;

    invoke-virtual {v1}, Lcom/freeme/elementscenter/ui/ECChildModeItemAdapter;->getItemDataList()Ljava/util/List;
...
.method private enrtyManagerFragment()V
    ...
    invoke-direct {p0}, Lcom/freeme/elementscenter/ui/ECChildMode;->constructManagerDatas()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/freeme/elementscenter/ui/ECChildMode;->getActivity()Landroid/app/Activity;
...
.method private declared-synchronized handleLocalData(ILjava/util/List;)V
    ...
    :try_start_0
    invoke-direct {p0, p1}, Lcom/freeme/elementscenter/ui/ECChildMode;->showViewByStatus(I)V
    ...
    :cond_1
    iget-object p1, p0, Lcom/freeme/elementscenter/ui/ECChildMode;->mAdapter:Lcom/freeme/elementscenter/ui/ECChildModeItemAdapter;

    invoke-virtual {p1, p2}, Lcom/freeme/elementscenter/ui/ECChildModeItemAdapter;->setItemDataList(Ljava/util/List;)V
    :try_end_0
...
.method private handleReload()V
    ...
    invoke-direct {p0}, Lcom/freeme/elementscenter/ui/ECChildMode;->requestData()V
...
.method private initGridView()V
    ...
    iget-object v0, p0, Lcom/freeme/elementscenter/ui/ECChildMode;->mContainer:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/freeme/elementscenter/ui/ECChildMode;->mBody:Landroid/view/View;

    new-instance v0, Lcom/freeme/elementscenter/ui/ECChildModeItemAdapter;

    invoke-virtual {p0}, Lcom/freeme/elementscenter/ui/ECChildMode;->getActivity()Landroid/app/Activity;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/freeme/elementscenter/ui/ECChildModeItemAdapter;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/freeme/elementscenter/ui/ECChildMode;->mAdapter:Lcom/freeme/elementscenter/ui/ECChildModeItemAdapter;
    ...
    iput-object v0, p0, Lcom/freeme/elementscenter/ui/ECChildMode;->mGridView:Landroid/widget/GridView;

    iget-object v0, p0, Lcom/freeme/elementscenter/ui/ECChildMode;->mGridView:Landroid/widget/GridView;
...
.method private initLoadingBar()V
    ...
    iput-object v0, p0, Lcom/freeme/elementscenter/ui/ECChildMode;->mLoadingBar:Landroid/widget/ProgressBar;
...
.method private initPrompt()V
    ...
    iput-object v0, p0, Lcom/freeme/elementscenter/ui/ECChildMode;->mNoNetworkPrompt:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/freeme/elementscenter/ui/ECChildMode;->mReload:Landroid/widget/Button;

    iget-object v0, p0, Lcom/freeme/elementscenter/ui/ECChildMode;->mReload:Landroid/widget/Button;
...
.method private requestData()V
    ...
    invoke-direct {p0}, Lcom/freeme/elementscenter/ui/ECChildMode;->requestDataByTypeCode()V
    ...
    invoke-static {v2, v0}, Lcom/freeme/elementscenter/data/ECUtil;->jsonStrToECItemDataList(Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-direct {p0, v1, v0}, Lcom/freeme/elementscenter/ui/ECChildMode;->handleLocalData(ILjava/util/List;)V
    ...
    invoke-direct {p0, v0}, Lcom/freeme/elementscenter/ui/ECChildMode;->showViewByStatus(I)V
...
.method private requestDataByTypeCode()V
    ...
    iput-object v1, p0, Lcom/freeme/elementscenter/ui/ECChildMode;->mDataTask:Lcom/freeme/elementscenter/data/ECOnlineData;
...
.method private showViewByStatus(I)V
    ...
    iget-object v0, p0, Lcom/freeme/elementscenter/ui/ECChildMode;->mLoadingBar:Landroid/widget/ProgressBar;
    ...
    iget-object p1, p0, Lcom/freeme/elementscenter/ui/ECChildMode;->mBody:Landroid/view/View;

    invoke-virtual {p1, v2}, Landroid/view/View;->setVisibility(I)V

    iget-object p1, p0, Lcom/freeme/elementscenter/ui/ECChildMode;->mNoNetworkPrompt:Landroid/view/View;
...
.method public onBackPressed()Z
    ...
    iget-boolean v0, p0, Lcom/freeme/elementscenter/ui/ECChildMode;->hadIntercept:Z
    ...
    iput-boolean v0, p0, Lcom/freeme/elementscenter/ui/ECChildMode;->hadIntercept:Z

    invoke-virtual {p0}, Lcom/freeme/elementscenter/ui/ECChildMode;->getFragmentManager()Landroid/app/FragmentManager;
...
.method public onClick(Landroid/view/View;)V
    ...
    invoke-direct {p0}, Lcom/freeme/elementscenter/ui/ECChildMode;->handleReload()V
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    sget v0, Lcom/freeme/elementscenter/R$string;->ec_child_mode:I

    invoke-virtual {p3, v0}, Landroid/app/ActionBar;->setTitle(I)V

    const/4 p3, 0x1

    invoke-virtual {p0, p3}, Lcom/freeme/elementscenter/ui/ECChildMode;->setHasOptionsMenu(Z)V
    ...
    iput-object p1, p0, Lcom/freeme/elementscenter/ui/ECChildMode;->mContainer:Landroid/view/View;

    iget-object p1, p0, Lcom/freeme/elementscenter/ui/ECChildMode;->mContainer:Landroid/view/View;

    invoke-virtual {p1, p0}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-direct {p0}, Lcom/freeme/elementscenter/ui/ECChildMode;->initGridView()V

    invoke-direct {p0}, Lcom/freeme/elementscenter/ui/ECChildMode;->initPrompt()V

    invoke-direct {p0}, Lcom/freeme/elementscenter/ui/ECChildMode;->initLoadingBar()V

    invoke-direct {p0}, Lcom/freeme/elementscenter/ui/ECChildMode;->requestData()V

    invoke-direct {p0}, Lcom/freeme/elementscenter/ui/ECChildMode;->handleStatistic()V
...
.method public onDataReady(IILjava/util/List;)V
    ...
    invoke-direct {p0, p2, p3}, Lcom/freeme/elementscenter/ui/ECChildMode;->handleOnlineData(ILjava/util/List;)V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-direct {p0}, Lcom/freeme/elementscenter/ui/ECChildMode;->enrtyManagerFragment()V
...
.method public onPause()V
    ...
    iget-object v0, p0, Lcom/freeme/elementscenter/ui/ECChildMode;->mDataTask:Lcom/freeme/elementscenter/data/ECOnlineData;
    ...
    :cond_0
    iget-object v0, p0, Lcom/freeme/elementscenter/ui/ECChildMode;->mAdapter:Lcom/freeme/elementscenter/ui/ECChildModeItemAdapter;

    invoke-virtual {v0}, Lcom/freeme/elementscenter/ui/ECChildModeItemAdapter;->pause()V
...
.method public onResume()V
    ...
    iget-object v1, p0, Lcom/freeme/elementscenter/ui/ECChildMode;->mGridView:Landroid/widget/GridView;

    invoke-virtual {v0, v1}, Lcom/freeme/elementscenter/ui/ECChildModeItemAdapter;->resume(Landroid/widget/GridView;)V

    iget-object v0, p0, Lcom/freeme/elementscenter/ui/ECChildMode;->mAdapter:Lcom/freeme/elementscenter/ui/ECChildModeItemAdapter;

    invoke-virtual {v0}, Lcom/freeme/elementscenter/ui/ECChildModeItemAdapter;->notifyDataSetChanged()V
