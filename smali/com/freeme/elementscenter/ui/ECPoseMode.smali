.class public Lcom/freeme/elementscenter/ui/ECPoseMode;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mCurrPageIndex:I

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mdataTaskList:Ljava/util/List;

    return-void
.end method

.method static synthetic access$000(Lcom/freeme/elementscenter/ui/ECPoseMode;)I
    .locals 0

    iget p0, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mCurrPageIndex:I

    return p0
.end method

.method static synthetic access$002(Lcom/freeme/elementscenter/ui/ECPoseMode;I)I
    .locals 0

    iput p1, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mCurrPageIndex:I

    return p1
.end method

.method static synthetic access$100(Lcom/freeme/elementscenter/ui/ECPoseMode;)Lcom/freeme/elementscenter/dc/ui/TabWidget;
    .locals 0

    iget-object p0, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mTabWidget:Lcom/freeme/elementscenter/dc/ui/TabWidget;
...
.method private constructManagerDatas(Z)Ljava/util/List;
    ...
    :goto_0
    iget-object v2, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mPageTitle:[Ljava/lang/String;

    array-length v2, v2

    if-ge p1, v2, :cond_4

    invoke-direct {p0, p1}, Lcom/freeme/elementscenter/ui/ECPoseMode;->getPageDataItemList(I)Ljava/util/List;
    ...
    :cond_2
    iget p1, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mCurrPageIndex:I
...
.method private enrtyManagerFragment()V
    ...
    invoke-direct {p0, v0}, Lcom/freeme/elementscenter/ui/ECPoseMode;->constructManagerDatas(Z)Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/freeme/elementscenter/ui/ECPoseMode;->getActivity()Landroid/app/Activity;
...
.method private getPageDataItemList(I)Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mPageList:Ljava/util/List;
...
.method private declared-synchronized handleLocalData(ILjava/util/List;)V
    ...
    :try_start_0
    sget-object v0, Lcom/freeme/elementscenter/data/ECUtil;->POSEMODE_TYPE_ARRAY:[Ljava/lang/String;
    ...
    :cond_0
    invoke-direct {p0, v1}, Lcom/freeme/elementscenter/ui/ECPoseMode;->showViewByStatus(I)V
    ...
    invoke-direct {p0, v0}, Lcom/freeme/elementscenter/ui/ECPoseMode;->showViewByStatus(I)V
...
.method private handleReload()V
    ...
    invoke-direct {p0}, Lcom/freeme/elementscenter/ui/ECPoseMode;->requestData()V
...
.method private initBody()V
    ...
    iget-object v0, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mContainer:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mBody:Landroid/view/View;

    invoke-direct {p0}, Lcom/freeme/elementscenter/ui/ECPoseMode;->initTabWidget()V

    invoke-direct {p0}, Lcom/freeme/elementscenter/ui/ECPoseMode;->initViewPager()V
...
.method private initLoadingBar()V
    ...
    iput-object v0, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mLoadingBar:Landroid/widget/ProgressBar;
...
.method private initPrompt()V
    ...
    iput-object v0, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mNoNetworkPrompt:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mReload:Landroid/widget/Button;

    iget-object v0, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mReload:Landroid/widget/Button;
...
.method private initTabWidget()V
    ...
    sget v1, Lcom/freeme/elementscenter/R$array;->ec_pose_pagetitles:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getStringArray(I)[Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mPageTitle:[Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mTabWidget:Lcom/freeme/elementscenter/dc/ui/TabWidget;

    iget-object v0, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mTabWidget:Lcom/freeme/elementscenter/dc/ui/TabWidget;
    ...
    iget-object v0, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mPageTitle:[Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mTabWidget:Lcom/freeme/elementscenter/dc/ui/TabWidget;
...
.method private initViewPager()V
    ...
    iput-object v0, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mPager:Landroid/support/v4/view/ViewPager;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mPageList:Ljava/util/List;
    ...
    iget-object v3, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mPageTitle:[Ljava/lang/String;

    aget-object v3, v3, v1

    invoke-virtual {v2, v3}, Lcom/freeme/elementscenter/ui/ECPageViewItem;->setTag(Ljava/lang/Object;)V

    iget-object v3, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mPageList:Ljava/util/List;
    ...
    iget-object v2, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mPageList:Ljava/util/List;

    invoke-direct {v1, v2}, Lcom/freeme/elementscenter/ui/ECPagerAdapter;-><init>(Ljava/util/List;)V

    iput-object v1, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mPageAdapter:Lcom/freeme/elementscenter/ui/ECPagerAdapter;

    iget-object v1, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mPager:Landroid/support/v4/view/ViewPager;

    iget-object v2, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mPageAdapter:Lcom/freeme/elementscenter/ui/ECPagerAdapter;
    ...
    iget-object v0, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mPager:Landroid/support/v4/view/ViewPager;

    new-instance v1, Lcom/freeme/elementscenter/ui/ECPoseMode$1;

    invoke-direct {v1, p0}, Lcom/freeme/elementscenter/ui/ECPoseMode$1;-><init>(Lcom/freeme/elementscenter/ui/ECPoseMode;)V
...
.method private requestData()V
    ...
    iget-object v2, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mdataTaskList:Ljava/util/List;
    ...
    invoke-direct {p0, v2}, Lcom/freeme/elementscenter/ui/ECPoseMode;->requestDataByType(I)V
    ...
    invoke-direct {p0, v1, v2}, Lcom/freeme/elementscenter/ui/ECPoseMode;->handleLocalData(ILjava/util/List;)V
...
.method private requestDataByType(I)V
    ...
    iget-object p1, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mdataTaskList:Ljava/util/List;
...
.method private showViewByStatus(I)V
    ...
    iget-object v0, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mLoadingBar:Landroid/widget/ProgressBar;
    ...
    iget-object p1, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mBody:Landroid/view/View;

    invoke-virtual {p1, v2}, Landroid/view/View;->setVisibility(I)V

    iget-object p1, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mNoNetworkPrompt:Landroid/view/View;
...
.method public onBackPressed()Z
    ...
    iget-boolean v0, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->hadIntercept:Z
    ...
    iput-boolean v0, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->hadIntercept:Z

    invoke-virtual {p0}, Lcom/freeme/elementscenter/ui/ECPoseMode;->getFragmentManager()Landroid/app/FragmentManager;
...
.method public onClick(Landroid/view/View;)V
    ...
    invoke-direct {p0}, Lcom/freeme/elementscenter/ui/ECPoseMode;->handleReload()V
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    sget v0, Lcom/freeme/elementscenter/R$string;->ec_pose_mode:I

    invoke-virtual {p3, v0}, Landroid/app/ActionBar;->setTitle(I)V

    const/4 p3, 0x1

    invoke-virtual {p0, p3}, Lcom/freeme/elementscenter/ui/ECPoseMode;->setHasOptionsMenu(Z)V
    ...
    iput-object p1, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mContainer:Landroid/view/View;

    iget-object p1, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mContainer:Landroid/view/View;

    invoke-virtual {p1, p0}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iput v0, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mCurrPageIndex:I

    invoke-direct {p0}, Lcom/freeme/elementscenter/ui/ECPoseMode;->initBody()V

    invoke-direct {p0}, Lcom/freeme/elementscenter/ui/ECPoseMode;->initPrompt()V

    invoke-direct {p0}, Lcom/freeme/elementscenter/ui/ECPoseMode;->initLoadingBar()V

    invoke-direct {p0, v0}, Lcom/freeme/elementscenter/ui/ECPoseMode;->showViewByStatus(I)V

    invoke-direct {p0}, Lcom/freeme/elementscenter/ui/ECPoseMode;->requestData()V

    invoke-direct {p0}, Lcom/freeme/elementscenter/ui/ECPoseMode;->handleStatistic()V
...
.method public onDataReady(IILjava/util/List;)V
    ...
    invoke-direct {p0, p2, p3}, Lcom/freeme/elementscenter/ui/ECPoseMode;->handleOnlineData(ILjava/util/List;)V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-direct {p0}, Lcom/freeme/elementscenter/ui/ECPoseMode;->enrtyManagerFragment()V
...
.method public onPause()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mdataTaskList:Ljava/util/List;
...
.method public onTabSelected(I)V
    ...
    iget v0, p0, Lcom/freeme/elementscenter/ui/ECPoseMode;->mCurrPageIndex:I
