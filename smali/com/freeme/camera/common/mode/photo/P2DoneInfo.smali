.class public Lcom/freeme/camera/common/mode/photo/P2DoneInfo;
...
.method static constructor <clinit>()V
    ...
    const-class v1, Lcom/freeme/camera/common/mode/photo/P2DoneInfo;
    ...
    sput-object v0, Lcom/freeme/camera/common/mode/photo/P2DoneInfo;->TAG:Lcom/freeme/camera/common/debug/LogUtil$Tag;
    ...
    sput-object v1, Lcom/freeme/camera/common/mode/photo/P2DoneInfo;->P2DONE_SUPPORT:[I

    sput-boolean v2, Lcom/freeme/camera/common/mode/photo/P2DoneInfo;->mIsSupport:Z
...
.method public static checkP2DoneResult(Landroid/hardware/camera2/CaptureResult;)Z
    ...
    sget-boolean v0, Lcom/freeme/camera/common/mode/photo/P2DoneInfo;->mIsSupport:Z

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    sget-object v0, Lcom/freeme/camera/common/mode/photo/P2DoneInfo;->mKeyP2NotificationResult:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    sget-object v0, Lcom/freeme/camera/common/mode/photo/P2DoneInfo;->P2DONE_SUPPORT:[I
...
.method public static enableP2Done(Landroid/hardware/camera2/CaptureRequest$Builder;)Z
    ...
    sget-object v0, Lcom/freeme/camera/common/mode/photo/P2DoneInfo;->mKeyP2NotificationRequest:Landroid/hardware/camera2/CaptureRequest$Key;

    sget-object v1, Lcom/freeme/camera/common/mode/photo/P2DoneInfo;->P2DONE_SUPPORT:[I
...
.method public static setCameraCharacteristics(Landroid/content/Context;I)V
    ...
    sput-boolean p1, Lcom/freeme/camera/common/mode/photo/P2DoneInfo;->mIsSupport:Z

    :cond_0
    sget-object p1, Lcom/freeme/camera/common/mode/photo/P2DoneInfo;->TAG:Lcom/freeme/camera/common/debug/LogUtil$Tag;
    ...
    sget-boolean v1, Lcom/freeme/camera/common/mode/photo/P2DoneInfo;->mIsSupport:Z
    ...
    sget-boolean p1, Lcom/freeme/camera/common/mode/photo/P2DoneInfo;->mIsSupport:Z
    ...
    sput-object p1, Lcom/freeme/camera/common/mode/photo/P2DoneInfo;->mKeyP2NotificationRequest:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    sput-object p0, Lcom/freeme/camera/common/mode/photo/P2DoneInfo;->mKeyP2NotificationResult:Landroid/hardware/camera2/CaptureResult$Key;
